...
#' @param add_rolloing_avg is set to c(TRUE,7), this retruns the 7 day rolling average
#' @param add_bar is set to TRUE, this adds a line to the epicurve
#' @param color_select is set to NULL, this is the color of the epicurve bars
#'
